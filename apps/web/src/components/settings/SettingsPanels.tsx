...
export function useSettingsRestore(onRestored?: () => void) {
  ...
  const restoreDefaults = useCallback(async () => {
    ...
    updateSettings({
      ...
      sidebarProjectsDefaultExpanded: DEFAULT_UNIFIED_SETTINGS.sidebarProjectsDefaultExpanded,
    ...
    onRestored?.();
  }, [changedSettingLabels, onRestored, setCustomTheme, setTheme, updateSettings]);
    ...
    <SettingsPageContainer>
      <SettingsSection title="General">
        ...
        <SettingsRow
          ...
          description="Choose whether projects start expanded in the sidebar before you override them."
          resetAction={
            settings.sidebarProjectsDefaultExpanded !==
            DEFAULT_UNIFIED_SETTINGS.sidebarProjectsDefaultExpanded ? (
              <SettingResetButton
          ...
          control={
            <Switch
              ...
              aria-label="Expand projects by default"
            />
          }
        />
